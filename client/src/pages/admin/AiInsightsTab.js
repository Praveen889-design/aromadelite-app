    ...
    return (
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center',
        ...
        <p style={{ fontSize: 14, color: '#64748b', maxWidth: 460, lineHeight: 1.6, margin: '0 0 28px' }}>
          Powered by <strong>Google Gemini 2.5 Flash</strong>. Analyzes your last 30 days of
        ...
        <div style={{ marginTop: 20, fontSize: 11, color: '#94a3b8' }}>
          Uses Gemini 2.5 Flash (free tier) · No client PII sent to AI · ~5 seconds
        </div>
      </div>
    );
  }
      ...
      <div style={{
        ...
        <div>
          ...
          <div style={{ fontSize: 12, color: '#ddd6fe', marginTop: 2 }}>
            Generated at {fmtTime(generatedAt)} · Powered by Gemini 2.5 Flash · Last 30 days data
          </div>
        </div>
        <button onClick={generate} style={{
